...
public class AuthServiceImpl implements AuthService {
    ...
    public ResponseEntity<ApiResponseDto<?>> save(
        ...
        try {
            ...
            notificationService
                    .sendUserRegistrationVerificationEmail(user);
    ...
    @Override
    public ResponseEntity<ApiResponseDto<?>> verifyRegistrationVerification(
            String code
        ...
        long codeExpiryTimeInMillis =
                user.getVerificationCodeExpiryTime().getTime();

        if (currentTimeInMs > codeExpiryTimeInMillis) {
            throw new UserVerificationFailedException(
                    "Verification failed: expired verification code!"
            );
        }
    ...
    public ResponseEntity<ApiResponseDto<?>> resendVerificationCode(
        ...
        try {
            ...
            user.setVerificationCodeExpiryTime(
    ...
    verifyEmailAndSendForgotPasswordVerificationEmail(
            String email
        ...
        if (userService.existsByEmail(email)) {
            ...
            try {
                ...
                notificationService
                        .sendForgotPasswordVerificationEmail(user);
                ...
                log.error(
                        "Reset password email verification failed: {}",
                        e.getMessage()
                );
        ...
        throw new UserNotFoundException(
                "Verification failed: User not found with email "
                        + email + "!"
        );
    }
    ...
    @Override
    public ResponseEntity<ApiResponseDto<?>>
    verifyForgotPasswordVerification(
            String code
    ) throws UserVerificationFailedException,
            UserServiceLogicException {
    ...
    public ResponseEntity<ApiResponseDto<?>> resetPassword(
        ...
        if (userService.existsByEmail(resetPasswordDto.getEmail())) {
            ...
            try {
                ...
                throw new UserServiceLogicException(
                        "Failed to reset your password: Try again later!"
                );
            }
        }
    ...
    private Date calculateCodeExpirationTime() {
        ...
        return new Date(currentTimeInMs + expiryPeriod);
    }
