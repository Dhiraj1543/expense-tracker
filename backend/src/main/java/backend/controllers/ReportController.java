...
public class ReportController {
    ...
    public ResponseEntity<ApiResponseDto<?>> getTotalIncomeOrExpense(
        ...
        return reportService.getTotalByTransactionTypeAndUser(
                userId,
                transactionTypeId,
                month,
                year
    ...
    public ResponseEntity<ApiResponseDto<?>> getTotalNoOfTransactions(
        ...
        return reportService.getTotalNoOfTransactionsByUser(
                userId,
                month,
                year
        );
    ...
    public ResponseEntity<ApiResponseDto<?>> getTotalByCategory(
        ...
        return reportService.getTotalExpenseByCategoryAndUser(
                email,
                categoryId,
                month,
                year
